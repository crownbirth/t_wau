...
if(isset($_POST['save']) && $_POST['save'] != '') {
    ...
    $required = array('lga', 'sponsorname', 
            ...
            'address', 'soforig', 'dob', 'phone', 'progid2');
        
    if($row_rschk['admtype']=='DE') {
        $required = array_merge($required, array('fname', 'lname', 'mname', 'sex',
            'jambregid', 'age', 'deschname', 'degradyear', 'degrade', 'jambyear', 'progid1'));
    }
    $omitted = array();
       ...
       $admission_type = $row_rschk['admtype'];
        ...
        if(empty($omitted)) {
            ...
            $insertSQL = sprintf("UPDATE prospective "
                    ...
                    . "sponsorphn=%s,sponsoradrs=%s,"
                    . " access=%s,sesid=%s,phone=%s, age=%s, DoB=%s, formsubmit=%s, stid=%s, address=%s, Religion=%s, email=%s, healthStatus=%s, progid2=%s WHERE jambregid=%s",
                                                       GetSQLValueString($_POST['lga'], "text"),
                                                       GetSQLValueString($_POST['sponsorname'], "text"),
                                                       GetSQLValueString($_POST['sponsorphn'], "text"),
                                                       GetSQLValueString($_POST['sponsoradrs'], "text"),
                ...
                <td width="442" align="left" valign="top">
                    <?php
                        ...
                        if($row_rschk['admtype']=='UTME')
                            $progid = (isset($row_rschk['progid1']))? $row_rschk['progid1']:'';
                    ?>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">
                                        ...
                                        <select name="religion" id="religion">
                                            <option value="-1">--Choose--</option>
                                            <option value="Christian" <?php if('Christianity' == $religion)echo 'selected'?>>Christian</option>
                                            <option value="Muslim" <?php if('Islam' == $religion)echo 'selected'?>>Muslim</option>
                                        </select>
                        ...
                        <table width="320" class="table table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        $jambscr1 = '';
                                        if(isset($row_rschk['jambscr1']))
                                            $jambscr1 = $row_rschk['jambscr1'];
                                    ?>
                                    <?php echo $jambscr1;?></td>
                            </tr>
                            <tr>
                                <td>
                                    <?php
                                        $jambsubj2 = '';
                                        if(isset($row_rschk['jambsubj2']))
                                ...
                                <td>
                                    <?php
                                        $jambscr2 = '';
                                        if(isset($row_rschk['jambscore2']))
                                            $jambscr2 = $row_rschk['jambscore2'];
                                    ?>
                                    <?php echo $jambscr2;?></td>
                            </tr>
                            <tr>
                                <td>
                                    <?php
                                        $jambsubj3 = '';
                                        if(isset($row_rschk['jambsubj3']))
                                ...
                                <td>
                                    <?php
                                        $jambscr3 = '';
                                        if(isset($row_rschk['jambscore3']))
                                            $jambscr3 = $row_rschk['jambscore3'];
                                    ?>
                                    <?php echo $jambscr3?></td>
                            </tr>
                            <tr>
                                <td>
                                    <?php
                                        $jambsubj4 = '';
                                        if(isset($row_rschk['jambsubj4']))
                                ...
                                <td>
                                    <?php
                                        $jambscr4 = '';
                                        if(isset($row_rschk['jambscore4']))
                                            $jambscr4 = $row_rschk['jambscore4'];
                                    ?>
                                    <?php echo $jambscr4;?></td>
                            </tr>
                        </table>
                        <p>&nbsp;</p>
                    </td>
                        ...
                        <table width="320" class="table table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <?php
                                        $progid1 = '';
                                        $disabled = ($row_rschk['admtype']=='DE')? '': 'disabled';
