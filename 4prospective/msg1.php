      ...
      <tr>
        <td>
            ...
            <p>
                ...
                Payment for your Application fee quoting your Registration Number 
            </p>
            <p>
            ...
            <p>
                <a href="../prospective/index.php">Click Here</a> 
        ...
        <?php
	     ...
	     $headers .= "Content-Type: text/html;\r\n charset=\"iso-8859-1\"\r\n";
            ...
            $body = "<html>
            	<head>
            	     <title>WAUU- TAMS New Account Information</title>	
            	</head>
            	<body>
            	      Dear {$fname} {$lname},\n <p>Congratulations ...</p>
                        <p>
                            Your Account Profile  for {$ses} Application for Admission to {$university} has been created successfully 
