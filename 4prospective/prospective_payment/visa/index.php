            ...
            <tr>
                <td colspan="2">
                    ...
                    <table width="690" class="table table-striped table-bordered table-condensed">
                        ...
                        <tr>
                            <th>Full Name : </th>
                            <td><?php echo strtoupper($row_rspros['lname']).' '.strtoupper($row_rspros['fname']) ?></td>
                        </tr>
                        <tr>
                            <th>Application type : </th>
                            <td><?php echo $row_rspros['admtype']?></td>
                        </tr>
                        <tr>
                                ...
                                <table width="200" align="center" >
                                    <form name="form1" method="post" action="<?php echo "processpayment.php"?>">
                                        <tr>
                                            ...
                                            <td width="50%">
                                                <input type="button" onclick="javacript:location='../../termsandcon.php'" value="Cancel"/>
                                            </td>
                                        </tr>
                                        <input type="hidden" name="jambregid" value="<?php echo $row_rspros['jambregid'] ?>"/>
