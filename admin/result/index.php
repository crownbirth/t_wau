...
mysql_select_db($database_tams, $tams);
$query_prog = sprintf("SELECT progid, progname, p.deptid, deptname FROM programme p, department d WHERE d.deptid = p.deptid AND p.deptid = %s", GetSQLValueString($colname_prog, "int"));
...
mysql_select_db($database_tams, $tams);
$query_deptcrs = sprintf("SELECT DISTINCT c.csid, csname, upload, approve FROM course c, department_course dc, teaching t WHERE c.csid = dc.csid AND c.csid = t.csid AND dc.csid = t.csid AND dc.deptid = t.deptid AND dc.deptid = %s AND t.sesid = %s ORDER BY csid ASC", 
  ...
  <div class="content"><!-- InstanceBeginEditable name="maincontent" -->
    <table width="690">		
      ...
      <tr>
        ...
        <td width="138">Choose Department<br/>
        ...
        <td width="138">Choose Session<br/>
