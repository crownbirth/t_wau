...
if(isset($_POST['save']) && $_POST['save'] != '') {
    ...
    $insertSQL = sprintf("UPDATE prospective SET fname=%s, lname=%s, mname=%s, sex=%s, dob=%s, age=%s, id_num=%s, email=%s,"
                        ...
                        . "progid1=%s, progid2=%s, progmode=%s, study_mode=%s,past_school1=%s, past_school2=%s, "
                        . "past_school3=%s, formsubmit=%s, healthStatus=%s, sponsoradrs=%s WHERE jambregid=%s",
    ...
    $query_details = sprintf("SELECT can_no, can_name, sesid, reference, year, date_time "
    ...
    $insertSQL = sprintf("INSERT INTO schfee_transactions (can_no, can_name, sesid, reference, amt, year, status, "
                        . "date_time, ordid, percentPaid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                        GetSQLValueString($row_rschk['can_no'], "text"),
                        GetSQLValueString($row_details['can_name'], "text"),
                        GetSQLValueString($row_details['sesid'], "text"),
                        GetSQLValueString($ref, "text"),
                        GetSQLValueString('NGN200,000', "text"),
                        GetSQLValueString($row_details['year'], "text"),
                    ...
                    <td colspan="4">
                        <table width="320" class="table table-hover table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td><input type="text"name="schname1" required="required" size="40" value="<?php echo isset($pschl1[0])? $pschl1[0]: ''?>"/></td>
                                    <td><input type="text"name="from1" required="required" placeholder="YYYY" size="5" value="<?php echo isset($pschl1[1])? $pschl1[1]: ''?>"/></td>
                                    <td><input type="text"name="to1" required="required" placeholder="YYYY" size="5" value="<?php echo isset($pschl1[2])? $pschl1[2]: ''?>"/></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td><input type="text" name="schname2" required="required" size="40" value="<?php echo isset($pschl2[0])? $pschl2[0]: ''?>"/></td>
                                    <td><input type="text" name="from2"  placeholder="YYYY" size="5" value="<?php echo isset($pschl2[1])? $pschl2[1]: ''?>"/></td>
                                    <td><input type="text" name="to2"  placeholder="YYYY" size="5" value="<?php echo isset($pschl2[2])? $pschl2[2]: ''?>"/></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td><input type="text" name="schname3" size="40" value="<?php echo isset($pschl3[0])? $pschl3[0]: ''?>"/></td>
                                    <td><input type="text" name="from3"  placeholder="YYYY" size="5" value="<?php echo isset($pschl3[1])? $pschl3[1]: ''?>"/></td>
                                    <td><input type="text" name="to3"  placeholder="YYYY" size="5" value="<?php echo isset($pschl3[2])? $pschl3[2]: ''?>"/></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
