...
<?php include '../include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" -->Undergraduate Application Form<!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
      ...
      <tr>
        <td>
            <table width="670" class="table table-condensed table-bordered">
                    ...
                    <td colspan="2">
                        <table class="table table-condensed table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td><strong>Nationality : </strong><?php echo $row_rspros['nationality']?></td>
                    ...
                    <td colspan="2">
                        <table width="320" class="table table-hover table-striped table-bordered">     
                            <tr>
                                ...
                                <td><?php echo (isset($row_rspros['id_num']))?$row_rspros['id_num']:"NULL" ?></td>
                            </tr>
                            <tr>
                                <th>Date Of Birth</th>
                                <td><?php echo $row_rspros['DoB'] ?></td>
                            </tr>
                            <tr>
                                <th>Health Status</th>
                                <td><?php echo $row_rspros['healthStatus'] ?></td>
                            </tr>
                            <tr>
                                <th>Religion</th>
                                <td><?php echo $row_rspros['Religion'] ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2"><strong> Previous School Attended  </strong></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <table width="320" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td><?php echo $pschl1[0]?></td>
                                    <td><?php echo $pschl1[1]?></td>
                                    <td><?php echo $pschl1[2]?></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td><?php echo $pschl2[0]?></td>
                                    <td><?php echo $pschl2[1]?></td>
                                    <td><?php echo $pschl2[2]?></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td><?php echo $pschl3[0]?></td>
                                    <td><?php echo $pschl3[1]?></td>
                                    <td><?php echo $pschl3[2]?></td>
                                </tr>
