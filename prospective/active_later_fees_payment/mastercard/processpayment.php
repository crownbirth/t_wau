...
//echo $description. "<br/>\n";
		$xml = "<?xml version='1.0' encoding='UTF-8'?>
				...
				<ApproveURL>http://portal.tasued.edu.ng/tams/prospective/paid.php</ApproveURL>
				<CancelURL>http://portal.tasued.edu.ng/tams/prospective/cancel.php</CancelURL>
				<DeclineURL>http://portal.tasued.edu.ng/tams/prospective/declined.php</DeclineURL>
				</Order>
				</Request>
				</TKKPG>";
...
$sql="INSERT INTO schfee_transactions (can_no,can_name, reference, year, status, date_time, ordid, sessionid,gatewayurl,percentPaid) VALUES('$canNo','$canName','$ref','$year' ,'$status' ,'$date','$orderid','$sessionid','$gateway_url','$percent')";
