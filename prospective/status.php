              ...
              <td>
                  <table class="table table-condensed table-bordered table-striped">
                    ...
                    <?php if($admitted && !$accepted ){?>        
                                ...
                                <td colspan="1"> <a href="schoolfees_payment"><button>Pay Acceptance Fees</button></a></td>
                          </tr> 
                    <?php }?>
                    <?php if($admitted && $accepted && !$schoolfee) {?>
                             <tr>
                                <td height="44" colspan="2"> <br/>Our record shows that you have paid for ACCEPTANCE FEES. Visit the Admissions Office for other necessary actions. If you have fulfilled all admission requirements, 
                                    <a href="schoolfees_payment/">Click Here</a> to pay your School Fees.</td>
                            </tr>
