...
mysql_select_db($database_tams, $tams);
 $query_paid= sprintf("SELECT * FROM olevelverifee_transactions  WHERE year='".$cyr."' AND status='APPROVED' AND can_no='".$std."'") ;
  ...
  <div class="content"><!-- InstanceBeginEditable name="maincontent" -->
        <table width="690" >
            ...
            <tr>
                ...
                <td align="center"><input type="button" onclick="javascript:location='../../index.php'" value="Cancel"/></td>
            </tr>
        </table>
