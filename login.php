        ...
        <td><form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
          ...
          <table width="497" border="0" align="center">
           <?php if( $loginState ){?> <tr>
            ...
            <tr>
              <td width="110" height="24">User Name</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td width="64"><input type="submit" name="login" id="login" value="Login" /></td>
              <td width="309"><a href="reset_password.php">Forgot Password?</a></td>
            </tr>
        </table>
        </form></td>
      </tr>
