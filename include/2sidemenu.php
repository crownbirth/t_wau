...
<ul class="sidemenu">
 ...
 <!-- <li><a href="#" class="sidemenu">Department</a></li>
  ...
  <li><a href="<?php echo $adminlink."/";?>result/spreadsheet.php" class="sidemenu">Summary Sheet</a></li>
</ul>
<?php } 
...
<ul class="sidemenu">
  ...
  <li><a href="<?php echo $link."/";?>result/spreadsheet.php" class="sidemenu">Summary Sheet</a></li>
</ul>
