...
<ul class="sidemenu">
  <li><a href="<?php echo $link."/";?>college/" class="sidemenu">Faculties</a></li>
  ...
  <li><a href="<?php echo $link."/";?>prospective/" class="sidemenu">Admission</a></li>
...
<ul class="sidemenu">
  ...
  <li><a href="<?php echo $link."/";?>student/payhistory.php?stid=<?php echo getSessionValue('stid');?>" class="sidemenu">Payment History</a></li>
  <!--
  ...
  <?php }?> -->
  <?php if(getLevel($_SESSION['MM_Username'], $tams) == '4'){?>
