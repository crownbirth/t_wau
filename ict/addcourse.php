...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO course (csid, csname, semester, type, catid, deptid, cscont) "
...
<?php include 'include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" -->Add / Edit <?php echo $filtername;?> Courses<!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
            ...
            <table width="683" border="0">
              <?php if ($totalRows_courses > 0) { // Show if recordset not empty ?>
                ...
                <tr>
                  ...
                  <td width="44"><a href="editcourse.php?csid=<?php echo $row_courses['csid'];?>">Edit</a></td>
