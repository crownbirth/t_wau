...
//    }
    ...
    if(empty($omitted)) {
        ...
        $insertSQL = sprintf("UPDATE prospective "
                ...
                . "progid1=%s, progid2=%s,score =%s, progofferd=%s, adminstatus=%s  WHERE jambregid=%s",
                    ...
                    <fieldset>
                        ...
                        <table class="table table-bordered table-hover table-striped table-condensed">
                            <tr>
                                ...
                                <td><input type="text" name="score" id="email" value="<?php echo $row_rschk['score'];?>" size="7"/></td>
                            </tr>
                            <tr>
                                <td>Programme Offered </td>
                                <td>
                                    <select name="progoffered" id="progid2" style="width: 400px">
                                        <option value="-1">--Choose programme--</option>
                                        <?php
                                          do {  
                                          ?>
