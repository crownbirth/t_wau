...
$query_RsdeptStd = sprintf("SELECT d.deptname, count(s.stdid) as `count` "
        . "FROM student s, department d, programme p "
...
$query_RscolStd = sprintf("SELECT c.colname, count(s.stdid) as `count` "
        . "FROM student s, department d, programme p, college c "
        . "WHERE s.progid = p.progid "
        . "AND d.deptid = p.deptid "
        . "AND d.colid = c.colid "
        . "GROUP BY c.colid "
          ...
          <thead>
			...
			?>
              ...
              <tr align="center" >
                ...
                <td width="50">
                    <a target="_blank" href="studentlist.php?did=<?php echo $row_Rsdept['deptid']?>">
                        <?php echo $row_RsdeptStd['count'] ?>
                    </a>
                </td>
                <td width="50">
                    <a target="_blank" href="studentlist.php?action=reg&did=<?php echo $row_Rsdept['deptid']?>">
                        <?php echo isset($reg[$row_Rsdept['deptid']])? $reg[$row_Rsdept['deptid']]: 0; ?>
                    </a>
                </td>
                <td  width="50">
                    <a target="_blank" href="studentlist.php?action=clear&did=<?php echo $row_Rsdept['deptid']?>">
                        <?php echo isset($cleared[$row_Rsdept['deptid']])? $cleared[$row_Rsdept['deptid']]: 0?>
                    </a>
                </td>
                <td  width="50">
                    <a target="_blank" href="studentlist.php?action=paid&did=<?php echo $row_Rsdept['deptid']?>">
          ...
          <thead>
			...
			?>
              ...
              <tr align="center" >
                ...
                <td width="50">
                    <a target="_blank" href="studentlist.php?cid=<?php echo $row_Rscol['colid']?>">
                        <?php echo $row_RscolStd['count']?>
                    </a>
                </td>
                <td width="50">
                    <a target="_blank" href="studentlist.php?action=reg&cid=<?php echo $row_Rscol['colid']?>">
                        <?php echo isset($colreg[$row_Rscol['colid']])? $colreg[$row_Rscol['colid']]: 0; ?>
                    </a>
                </td>
                <td width="50">
                    <a target="_blank" href="studentlist.php?action=clear&cid=<?php echo $row_Rscol['colid']?>">
                        <?php echo isset($colcleared[$row_Rscol['colid']])? $colcleared[$row_Rscol['colid']]: 0?>
                    </a>
                </td>
                <td width="50">
                    <a target="_blank" href="studentlist.php?action=paid&cid=<?php echo $row_Rscol['colid']?>">
