    ...
    <table width="690">
      <tr>
	   ...
	   ?>
            <tr align="center" >
            	<td><?php echo $i;?></td>	
            	<td><a href="../student/profile.php?stid=<?php echo $row_rsstdnt['stdid']?>" target="_blank"><?php echo $row_rsstdnt['stdid']?></a></td>
                <td><?php echo $row_rsstdnt['fname']." ".$row_rsstdnt['lname']?></td>
                
               
                <td>
                <?php if(getIctAccess()=='20' ||getIctAccess()=='21'||getIctAccess()=='22'){?>
                <a href="editstdnt.php?stid=<?php echo $row_rsstdnt['stdid']; ?>">Edit</a>
                <?php }?>
                </td>
