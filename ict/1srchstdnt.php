...
$MM_authorizedUsers = "20,21,22,23,24";
...
<?php include 'include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" -->Search And Edit Student Record <!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
      ...
      <tr>
        <td height="37"><form id="form1" name="form1" method="post" action="">
          <table width="639" border="0" align="center">
            <tr>
              <td width="200" height="30" align="center">Search By Name or Matric No </td>
              <td width="371" align="center">
                  <input name="search" type="text" id="search" size="55" value="<?php echo $search?>"/>
              </td>
	   ...
	   ?>
            <tr align="center" >
                ...
                <?php 
                    if(getIctAccess() == 22) {
                        $link = "../student/profile.php?stid={$row_rsstdnt['stdid']}";
                        $label = "View Profile";
                    }else {
                        $link = "editstdnt.php?stid={$row_rsstdnt['stdid']}";
                        $label = "Edit Profile";
                    }
                ?>
                <td><a target="_blank" href="<?php echo $link; ?>"><?php echo $label?></a></td>
            </tr>
