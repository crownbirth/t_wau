...
require_once('functions/class.upload.php');
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE student SET stdid= %s, fname=%s, lname=%s, mname=%s, progid=%s, phone=%s, email=%s, addr=%s, sex=%s, dob=%s, sesid=%s, `level`=%s, `stid`=%s, admode=%s, `password`=%s, status=%s, `access`=%s, credit=%s, profile=%s WHERE stdid=%s",
        ...
        <td><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" enctype="multipart/form-data">
          <table align="center">
            <tr valign="baseline">
                ...
                <td width="266" align="left"><input type="file" name="filename"  /></td>
                <td width="211"  align="left" rowspan="6"><img src="<?php echo $image_url;?>" alt="" id="placeholder" name="placeholder" width="160" height="160" align="top"/></td>
              </tr>  
            <tr valign="baseline">
              <td nowrap="nowrap" align="left">Matric No.:</td>
              <td colspan="2" align="left"><input type="text" name="stdid" value="<?php echo $row_editstud['stdid']; ?>" <?php echo (getIctAccess() > 20)? "readonly=\"readonly\"": "" ?> /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="left">First Name:</td>
              <td colspan="2" align="left"><input type="text" name="fname" value="<?php echo htmlentities($row_editstud['fname'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="left">Last Name:</td>
              <td colspan="2" align="left"><input type="text" name="lname" value="<?php echo htmlentities($row_editstud['lname'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
            ...
            <?php }else{?>
              <input type="hidden" name="state" value="<?php echo htmlentities($row_editstud['stid'], ENT_COMPAT, 'utf-8')?>" />
            <?php }?>
            <tr valign="baseline">
