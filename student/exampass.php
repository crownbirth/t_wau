...
$image = array("../images/student/{$colname_stud}.jpg", 
                "../images/student/{$colname_stud}.JPG", 
                "../images/student/{$colname_stud}.png", 
                "../images/student/{$colname_stud}.PNG", 
                "../images/student/{$colname_stud}.gif", 
                "../images/student/{$colname_stud}.GIF"
                );
...
$query_info = sprintf("SELECT s.stdid, s.fname, s.sex, l.title, l.fname as lfname, l.lname as llname, "
        . "s.lname, s.level, s.progid, c.coltitle, p.progname, d.deptname "
            ...
            <tr>
                ...
                <td width="72%" align="center">
                    <div style="font-weight: bold;">
                        ...
                        <h4>'.$row_sess['sesname'].' Second Semester</h4>
