...
echo $query_history = sprintf('SELECT matric_no, can_name, ordid, status, reference, amt, date_time '
...
if($totalRows_history > 0) {
    $html ='<p style="text-align:center; font-size: 20pt; margin-bottom: 30px"><strong> SCHOOL FEES RECEIPT</strong></p>
