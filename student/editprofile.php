...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if(isset($_POST['password']) && $_POST['password'] != '') {
        echo $password = 'password='.GetSQLValueString(md5($_POST['password']), "text").',';
    }
    
  $updateSQL = sprintf("UPDATE student SET fname=%s, lname=%s, mname=%s, phone=%s, email=%s, addr=%s, sex=%s, %s profile=%s WHERE stdid=%s",
...
$image = array("../images/student/{$colname_editprof}.jpg", 
                "../images/student/{$colname_editprof}.JPG", 
                "../images/student/{$colname_editprof}.png", 
                "../images/student/{$colname_editprof}.PNG", 
                "../images/student/{$colname_editprof}.gif", 
                "../images/student/{$colname_editprof}.GIF"
                );
