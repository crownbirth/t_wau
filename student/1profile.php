...
$stud = (isset( $colname_student) )? $colname_student:"";
$filename = "profile.png";
$dh = opendir('../images/student/');
$excl = array('.','..');
while ($file = readdir($dh)){
    $len = strlen( $file ) - (strlen( $file ) - strpos( $file, '.'));
    if( !in_array($file,$excl) && substr( $file, 0, $len ) == $stud ){
        $filename = $file;
        break;
    }
}
  ...
  <div class="content"><!-- InstanceBeginEditable name="maincontent" -->
    <table width="690">
       <tr>       
        ...
        <a href="editprofile.php?stid=<?php echo $row_student['stdid']; ?>" >Edit Profile</a></td>      
        <?php }?>
      </tr>   
      ...
      <tr>
        <td width="175" rowspan="7" align="center"><img src="../images/student/<?php echo $filename;?>" alt="" name="profile_image" width="150" height="150" id="profile_image" />
