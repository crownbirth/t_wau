...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE college SET colname=%s, page_up=%s, page_down=%s WHERE colid=%s",
    ...
    <table width="690">
      <tr>
        <td><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table align="left">
            <tr valign="baseline">
              <td width="93" align="right" nowrap="nowrap">College Name:</td>
              <td width="421"><input type="text" name="colname" value="<?php echo htmlentities($row_editcol['colname'], ENT_COMPAT, 'utf-8'); ?>" size="50" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right" valign="middle" nowrap="nowrap">Top Content:</td>
              <td><textarea name="page_up" cols="60" rows="5" class="widgEditor nothing"><?php echo htmlentities($row_editcol['page_up'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right" valign="middle">Bottom Content:</td>
              <td><textarea name="page_down" cols="60" rows="5" class="widgEditor nothing"><?php echo htmlentities($row_editcol['page_down'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">&nbsp;</td>
              <td><input type="submit" value="Update College" /></td>
            </tr>
          </table>
