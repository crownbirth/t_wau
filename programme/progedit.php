...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE programme SET progname=%s, page_up=%s, page_down=%s WHERE progid=%s",
...
<?php include '../include/topmenu.php'; ?>
  ...
  <div class="pagetitle">
    <table width="600">
      <tr>
        <td><!-- InstanceBeginEditable name="pagetitle" -->Edit <?php echo $row_editprog['progname'];?><!-- InstanceEndEditable --></td>
      </tr>
    </table>
  </div>
<div class="sidebar1">
      ...
      <tr>
        <td>&nbsp;
          <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
            <table align="left">
              <tr valign="baseline">
                <td width="109" align="right" nowrap="nowrap">Programme Name:</td>
                <td width="433"><input type="text" name="progname" value="<?php echo htmlentities($row_editprog['progname'], ENT_COMPAT, 'utf-8'); ?>" size="50" /></td>
              </tr>              
              <tr valign="baseline">
                <td nowrap="nowrap" align="right" valign="top">Bottom Content:</td>
                <td><textarea name="page_down" cols="50" rows="5" class="widgEditor nothing"><?php echo htmlentities($row_editprog['page_down'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="right">&nbsp;</td>
                <td><input type="submit" value="Update Programme" /></td>
              </tr>
            </table>
