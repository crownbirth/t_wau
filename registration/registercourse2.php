...
$query_ref = sprintf("SELECT d.csid, d.status, c.csname, d.unit "
...
$query_cur = sprintf("SELECT d.csid, d.status, c.csname, d.unit "
        . "FROM department_course d "
        . "JOIN course c ON c.csid = d.csid "
