      ...
      <tr>
        <td>
          <table width="670" cellspacing="5" cellpadding="5">
            <tr>
            <?php if( getAccess() == 2 ){?>
              <td width="252">Choose Department<br/>
              ...
              <?php 
			  	$filter = "";
			  	if( getAccess() == 2 ){
					$filter = "?filter=col&cid=".getSessionValue('cid');
				}elseif( getAccess() == 3 ){
					$filter = "?filter=dept&did=".getSessionValue('did')."&cid=".getSessionValue('cid');
				}

			  ?>
              <a style="" href="../course/<?php echo $filter?>">View By Course</a></td>
            </tr>
          </table>
        </td>
      </tr>
